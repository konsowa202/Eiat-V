...
const BookingSchema = z.object({
  ...
  email: z.union([z.literal(""), z.string().email("البريد الإلكتروني غير صالح").trim()]).optional(),
              ...
              >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-2 md:col-span-2">
                    <Label htmlFor="email" className="text-gray-700 font-semibold">البريد الإلكتروني (اختياري)</Label>
                    <Input
                      id="email"
                      type="email"
                      {...register("email")}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  {/* Date Picker */}
                  <div className="space-y-2">
                    <Label htmlFor="date" className="text-gray-700 font-semibold">التاريخ المفضل (اختياري)</Label>
