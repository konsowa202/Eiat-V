...
export function WhatsAppTool() {
  ...
  const renderMetaTemplateSelector = () => (
    <>
      {!selectedMetaKey ? (
        <select
          style={{
...
const S: Record<string, React.CSSProperties> = {
  ...
  headerSub: {margin: '2px 0 0', fontSize: '11px', color: 'rgba(255,255,255,0.9)'},
  statsRow: {
    display: 'grid',
  ...
  grid: {display: 'grid', gridTemplateColumns: '1fr 1.4fr', gap: '10px', alignItems: 'start'},
  secTitle: {
    margin: '0 0 10px',
    fontSize: '13px',
    fontWeight: 700,
